...
# Notice that these files are not necessary for replicating the results in the paper.
    ...
    tryCatch(
      {
        ...
        name2 = paste0("03_simulation_study/01_sensitivity_study/results/time_gibbs_alow_", 
                      parameter_comb[gg,1], "_", parameter_comb[gg,2], "_", parameter_comb[gg,3], 
                      "_simu", n_sim, ".RDS")
