...
errors_spike_detection_JW= readRDS( file = "03_simulation_study/02_comparison_two-step_synthetic_data/output_RDS/errors_spike_detection_JW.RDS")
false_positive_rates_JW= readRDS( file = "03_simulation_study/02_comparison_two-step_synthetic_data/output_RDS/false_positive_rates_JW.RDS")
false_negative_rates_JW= readRDS( file = "03_simulation_study/02_comparison_two-step_synthetic_data/output_RDS/false_negative_rates_JW.RDS")
...
name = paste0("03_simulation_study/01_sensitivity_study/output_RDS/ARIs.RDS")
...
G
ggsave("03_simulation_study/02_comparison_two-step_synthetic_data/output_images/simulation_results.pdf", G, width = 8, height = 4)
ggsave("03_simulation_study/02_comparison_two-step_synthetic_data/output_images/simulation_results.eps",G, width = 8, height = 4, device = cairo_ps)
