...
G
ggsave("10_simulations_sensitivity/output_images/simulation_alow_results.pdf", G, width = 8, height = 8)
ggsave("10_simulations_sensitivity/output_images/simulation_alow_results..eps",G, width = 8, height = 8, device = cairo_ps)
