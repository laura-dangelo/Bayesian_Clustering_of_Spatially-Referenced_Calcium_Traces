...
saveRDS(errors_spike_detection_JW, file = "11_simulations_comparison_two-step/output_RDS/errors_spike_detection_JW.RDS")
saveRDS(false_positive_rates_JW, file = "11_simulations_comparison_two-step/output_RDS/false_positive_rates_JW.RDS")
saveRDS(false_negative_rates_JW, file = "11_simulations_comparison_two-step/output_RDS/false_negative_rates_JW.RDS")
