...
#     
#     name2 <- paste0("12_simulations_computational_cost/results/time_gibbs_n",n,"_TT", TT, "_sim", n_sim, ".RDS")
#     time <- readRDS(name2)    
#        
...
D2 = readRDS("12_simulations_computational_cost/output_RDS/D2.RDS")
library(tidyverse)
...
G
ggsave("12_simulations_computational_cost/output_images/comput_time.pdf", G, width = 8, height = 4)
ggsave("12_simulations_computational_cost/output_images/comput_time.eps",G, width = 8, height = 4, device = cairo_ps)
