...
for(i in 1:nrow(parameter_comb)){
  ...
  for(n_sim in 1:replications_sim){
    nameopen = paste0("12_simulations_computational_cost/simulated_data/simulated_data_n",n,"_TT", TT, "_sim", n_sim, ".RDS")
    ...
    tryCatch(
      {
        ...
        name = paste0("12_simulations_computational_cost/results/run_gibbs_n",n,"_TT", TT, "_sim", n_sim, ".RDS")
